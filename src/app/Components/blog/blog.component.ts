...
export class BlogComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.progressRef.start();
     this.ApiService.GetAllourServices("3").subscribe(
       res => {
  ...
  onSubmit(formValue){
    ...
    if (this.Userform.valid) {
      ...
      this.ApiService.CreateourServices(formValue).subscribe(
        res => {
  ...
  onUpdate(formValue) {
    ...
    if (this.Userform.valid) {
      ...
      this.ApiService.UpdateourServices(formValue,this.taskid).subscribe(
        res => {
  ...
  deleteTask(id) {
    ...
    swal.fire({
      ...
      if (result.value) {
       ...
       this.ApiService.DeleteourServices(id).subscribe(
         res => {
  ...
  updatetask(page, id) {
    ...
    this.ApiService.GetByIdourServices(id).subscribe(
      res => {
        let resources: any[] = res["data"];
