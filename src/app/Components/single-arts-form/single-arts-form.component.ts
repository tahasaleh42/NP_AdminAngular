...
@Component({
  selector: 'app-single-arts-form',
  templateUrl: './single-arts-form.component.html',
  styleUrls: ['./single-arts-form.component.scss']
})
export class SingleArtsFormComponent implements OnInit {
