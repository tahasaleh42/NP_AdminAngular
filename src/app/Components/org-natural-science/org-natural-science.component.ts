...
@Component({
  selector: 'app-org-natural-science',
  templateUrl: './org-natural-science.component.html',
  styleUrls: ['./org-natural-science.component.scss']
})
export class OrgNaturalScienceComponent implements OnInit {
