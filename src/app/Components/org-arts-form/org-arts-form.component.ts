...
@Component({
  selector: 'app-org-arts-form',
  templateUrl: './org-arts-form.component.html',
  styleUrls: ['./org-arts-form.component.scss']
})
export class OrgArtsFormComponent implements OnInit {
 ...
 /*    national_ID_card: new FormControl('',), */
  ...
  ngOnInit() {
    ...
    this.ApiService.GetAll_NominationFormByServices(7).subscribe(
     res => {
