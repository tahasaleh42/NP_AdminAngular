...
@Component({
  selector: 'app-org-medicin-form',
  templateUrl: './org-medicin-form.component.html',
  styleUrls: ['./org-medicin-form.component.scss']
})
export class OrgMedicinFormComponent implements OnInit {
 ...
 /*    national_ID_card: new FormControl('',), */
  ...
  ngOnInit() {
    ...
    this.ApiService.GetAll_NominationFormByServices(6).subscribe(
      res => {
