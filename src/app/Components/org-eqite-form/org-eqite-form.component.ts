...
@Component({
  selector: 'app-org-eqite-form',
  templateUrl: './org-eqite-form.component.html',
  styleUrls: ['./org-eqite-form.component.scss']
})
export class OrgEqiteFormComponent implements OnInit {
 ...
 /*    national_ID_card: new FormControl('',), */
  ...
  constructor(private cookieService: CookieService , private modalService: NgbModal,private ApiService:APiService,private progress: NgProgress,
  ...
  ngOnInit() {
    ...
    this.ApiService.GetAll_NominationFormByServices(34).subscribe(
      res => {
