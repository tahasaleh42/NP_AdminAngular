...
@Component({
  selector: 'app-org-social-form',
  templateUrl: './org-social-form.component.html',
  styleUrls: ['./org-social-form.component.scss']
})
export class OrgSocialFormComponent implements OnInit {
