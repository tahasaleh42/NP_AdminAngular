...
@Component({
  selector: 'app-single-natural-science',
  templateUrl: './single-natural-science.component.html',
  styleUrls: ['./single-natural-science.component.scss']
})
export class SingleNaturalScienceComponent implements OnInit {
 ...
 /*    national_ID_card: new FormControl('',), */
  ...
  ngOnInit() {
    ...
    this.progressRef.start();
      this.mainid =  3
    this.ApiService.GetAll_NominationFormByServices(3
      ).subscribe(
     res => {
