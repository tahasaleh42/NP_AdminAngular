...
@Component({
  selector: 'app-nomination-form-org',
  templateUrl: './nomination-form-org.component.html',
  styleUrls: ['./nomination-form-org.component.scss']
})
export class NominationFormOrgComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ApiService.GetAll_NominationFormByServices(this.mainid).subscribe(
     res => {
...
/*   fillForm(id){
    ...
    this.Userform.setValue({
      ...
      thes_ubmitted_work_has_not_won_any_previous_awards: '',
  ...
  onSubmit(formValue){
     ...
     if (this.Userform.valid) {
      ...
      formValue["user_Id"]=0
      formValue["summary"]="--"
      formValue["services_Id"]=this.mainid
      ...
      formValue["thes_ubmitted_work_has_not_won_any_previous_awards"]=this.imgPath8
   ...
   this.ApiService.GetByIdNominationForm(id).subscribe(
     res => {
       ...
       this.Userform.setValue({
        ...
        thes_ubmitted_work_has_not_won_any_previous_awards: this.taskArrD['thes_ubmitted_work_has_not_won_any_previous_awards'],
       ...
       this.imgPath8=this.taskArrD['thes_ubmitted_work_has_not_won_any_previous_awards']
       ...
       this.imgSrc8= this.imageHost + this.taskArrD['thes_ubmitted_work_has_not_won_any_previous_awards']
