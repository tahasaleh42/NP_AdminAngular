...
@Component({
  selector: 'app-single-eqite-form',
  templateUrl: './single-eqite-form.component.html',
  styleUrls: ['./single-eqite-form.component.scss']
})
export class SingleEqiteFormComponent implements OnInit {
